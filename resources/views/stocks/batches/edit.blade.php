...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('stock-batches.update', $batch) }}">
            @csrf
            @method('PUT')
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="qty_on_hand" min="0" class="form-control @error('qty_on_hand') is-invalid @enderror" value="{{ old('qty_on_hand', $batch->qty_on_hand) }}" required>
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" min="0" name="cost_price" class="form-control @error('cost_price') is-invalid @enderror" value="{{ old('cost_price', $batch->cost_price) }}" required>
                    </div>
            ...
            <div class="alert alert-info mt-3">
                ...
                <strong>Perhatian:</strong> Edit batch akan mempengaruhi data stok. Pastikan data yang Anda ubah sudah benar.
            </div>
